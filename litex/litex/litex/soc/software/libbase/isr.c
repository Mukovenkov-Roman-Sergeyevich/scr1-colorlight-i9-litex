...
/***********************************************************************************/
/* ISR IPIC Handling for SCR1.                                                     */
/* Copyright (c) 2023 Syntacore                                                    */
/*                                                                                 */
/* SPDX-License-Identifier: Apache-2.0                                             */
/*                                                                                 */
/* isr function modified from https://github.com/syntacore/zephyr                  */
...
/*                                                                                 */
/***********************************************************************************/
#elif defined(__scr1__)
void scr_ipic_init(void) {
    for (int i = 0; i < PLF_IPIC_IRQ_VEC_NUM; i++) {
        ipic_irq_setup(i, i, IPIC_IRQ_LEVEL, IPIC_IRQ_ENABLE);
    }
}

void isr(void) {
    unsigned long vector = ipic_soi();  // Start of interrupt
