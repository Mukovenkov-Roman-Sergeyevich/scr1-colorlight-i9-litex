...
from litex_boards.platforms import colorlight_i9
...
class BaseSoC(SoCCore):
    def __init__(self, board="i9", revision="7.2", toolchain="trellis", sys_clk_freq=60e6,
        ...
        **kwargs):
        ...
        platform = colorlight_i9.Platform(board=board, revision=revision, toolchain=toolchain)
...
def main():
    ...
    parser = LiteXArgumentParser(platform=colorlight_i9.Platform, description="LiteX SoC on Colorlight I9.")
    ...
    soc.platform.add_extension(colorlight_i9._sdcard_pmod_io)
